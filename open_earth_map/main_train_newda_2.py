...
def prepare_data(data_dir, img_size, n_classes, pprocess=None):
    ...
    [
        oem.transforms.RandomFlip(),
        oem.transforms.RandomFlip(direction="vertical"),
...
def main():
    ...
    # Dataset preparation
    # preprocess_input = get_preprocessing_fn(args.encoder, pretrained='imagenet')
